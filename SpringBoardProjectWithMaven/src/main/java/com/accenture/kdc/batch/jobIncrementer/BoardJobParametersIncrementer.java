package com.accenture.kdc.batch.jobIncrementer;
...
public class BoardJobParametersIncrementer implements JobParametersIncrementer {
	
	public static String RUN_ID = "run.id";
